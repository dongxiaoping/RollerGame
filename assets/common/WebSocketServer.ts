...
import { roomState, RaceState } from "./Const";
...
let createAndEnterRoom = { type: 'createAndEnterRoom', info: { roomId: 2234, raceCount: 4 } };
ws.onopen = () => {
...
ws.onmessage = (e: any): void => {
    ...
    var type = info.type
    var message = info.info as NoticeInfo
